...
namespace Faker.Core.Generators {
	internal sealed class TimeGenerator : Generator {
		...
		private static TimeSpan TimeStamp() => new(rndm.NextInt64(TimeSpan.TicksPerDay * 7));
		private static DateTime GetDateTime() => new(rndm.NextInt64(DateTime.Today.Ticks));
	}
}